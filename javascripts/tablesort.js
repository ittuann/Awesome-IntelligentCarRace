document$.subscribe(function () {
  ...
  tables.forEach(function (table) {
    console.log("Tablesort enabled for table", table);
    ...
    headerCells.forEach(function (cell) {
      if (cell.textContent.trim().includes("获奖")) {
        ...
        console.log("Award column added");
      }
    });
    ...
    Tablesort.extend('award', function(item) {
      return (
        typeof item === 'string' && AWARD_ORDER.includes(item)
      );
    }, function(a, b) {
